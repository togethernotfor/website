...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for Our Porch - Neighbor Relationship Management App",
};
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              These Terms of Service (&quot;Terms&quot;) govern your use of the Our Porch
              mobile application (&quot;App&quot;, &quot;Service&quot;) operated by Together Not For,
              LLC (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). By downloading, installing, or using
              the App, you agree to be bound by these Terms. If you do not agree
              with these Terms, do not use the App.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>
                Maintaining the security of your device and any data you store in
                the App
              </li>
              <li>
                Ensuring you have permission to store and manage information about
                other individuals
              </li>
              <li>
              ...
              <li>
                Respecting the privacy and consent of neighbors whose information
                you store
              </li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our Porch stores all data locally on your device. We do not collect,
              transmit, or store your data on external servers. You retain full
              ownership and control of all data you enter into the App.
            </p>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              relationships with neighbors and building community. You agree not to
              use the App to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>
                Store information about individuals without appropriate consent or
                legal basis
              </li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The App, including its design, features, graphics, and code, is owned
              by Together Not For, LLC and protected by copyright, trademark, and
              other intellectual property laws. Our name, logo, and branding are
              trademarks of Together Not For, LLC.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              You retain ownership of any data you create and store within the App.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, TOGETHER NOT FOR, LLC SHALL
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              You agree to indemnify, defend, and hold harmless Together Not For,
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              will be reflected in the App with a new &quot;Last updated&quot; date. Your
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              from your device. Upon termination, all data stored locally will be
              removed.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              App shall be resolved in the courts of the jurisdiction where
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              agreement between you and Together Not For, LLC regarding the use of
